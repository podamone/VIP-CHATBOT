...
STICKER = [
    "CAACAgUAAxkBAAIFYmc5xM5k9KMFqaJi_BZyXoObZdoWAALQCQAC5F_5VXcDjugSehGcNgQ",
    "CAACAgUAAxUAAWc5xIo6zaLzOmFMBjLBd8KnXyTjAAJACAACm3qIVfOf9UTna6tANgQ",
        ...
        for member in message.new_chat_members:
            ...
            if member.id == nexichat.id:
                ...
                try:
                    ...
                    chat_photo = (
                        groups_photo if groups_photo else "https://envs.sh/A_c.jpg"
                    )
                except AttributeError:
                    chat_photo = "https://envs.sh/A_c.jpg"
                except Exception as e:
                    pass
